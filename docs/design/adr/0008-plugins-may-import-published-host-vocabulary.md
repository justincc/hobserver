...
hermes-observer package or track its version".
...
**A plugin may import from hermes-observer, from the surfaces this app
...
- **`docs/writing-a-plugin.md`'s checklist changes** from "imports nothing
  from hermes-observer" to importing only published surfaces, and
