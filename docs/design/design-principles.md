...
| a tool's payload *shape* | whoever owns the tool — `plugins/memory/mem0/spans.py` for mem0's | `SPAN_READERS` beside the specs — [ADR 17](adr/0017-a-payload-reading-is-contributed-beside-the-spec-that-names-it.md) |
